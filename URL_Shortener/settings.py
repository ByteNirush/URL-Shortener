...
SECRET_KEY = 'django-insecure-+ttt&@uo$$%(x^fisv1=tj30h!-ug-nf$_fhwy*kgmiw2&p-1&'
...
# Where to send users when login is required
LOGIN_URL = '/auth/login/'
# Where to send users after logout (optional but useful)
